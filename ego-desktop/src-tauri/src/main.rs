...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::credits::get_credits_balance,
            commands::credits::mint_credits,
            commands::credits::pay_credits,
            ...
            commands::messenger::get_display_name,
            commands::messenger::set_display_name,
            commands::messenger::get_my_avatar,

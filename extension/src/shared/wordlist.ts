// Ego Desktop recovery-phrase wordlist (must stay byte-identical to
// get_bip39_wordlist() in ego-desktop/src-tauri/src/commands/auth.rs).
export const WORDLIST: readonly string[] = [
  ...
  'zero','zone','zoo','zenith','zeal','zest','zinc','zephyr',
  'zigzag','zodiac','zombie','zealous','zenlike','zoning','zoology','zoomed',
  'zirconia','zipcode','zipline','zeppelin','zipper','zenobia','zircon','zestful',
  'zealotry','zoetrope','zodiacal','zymurgy','zoeform','ziplock','zirconate','zestfully',
  'zealously','zenmaster','zookeeper','abacus','abalone','abbey','abdomen','abduct',
  'abhor','abide','abjure','ablaze','abode','abolish','abrupt','absolve',
  'abstain','abysmal','acclaim','accolade','accrue','accuse','ache','acme',
  'acorn','acquaint','acrid','acrobat','adamant','addendum','adhere','adjacent',
  'adjoin','adjunct','adorn','adroit','adulate','adverse','afflict','agile',
  'agitate','agony','ailment','alacrity','albeit','alcove','alder','aloft',
  'altruism','alum','amalgam','amble','ambrosia','amend','amiable','amiss',
  'amity','amnesty','ample','amputate','analogy','ancestry','anew','anguish',
  'animosity','annex','anomaly','apex','appease','aptitude','ardent','ardor',
  'arid','armor','artisan','ascend','ascent','ascribe','ashen','aspire',
  'astute','atone','atrium','attain','audacity','auspice','austere','avid',
  'axiom','azure','ballad','bastion','beacon','beckon','befall','befriend',
  'beguile','behold','benign','besiege','bestow','betide','beware','bountiful',
  'brazen','brisk','brooch',
];
